...
echo "pushing image my-app"
%CONTAINER_RUNTIME% tag my-app %REGISTRY_URL%/%REGISTRY_NAMESPACE%/my-app
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/my-app

echo "pushing image docker-node-mongo-starter"
%CONTAINER_RUNTIME% tag docker-node-mongo-starter %REGISTRY_URL%/%REGISTRY_NAMESPACE%/docker-node-mongo-starter
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/docker-node-mongo-starter
